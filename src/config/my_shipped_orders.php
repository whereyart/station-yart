	...
	*/
	...
	return [
			'panel_options'	=> [
				...
				'where' 				=> 'artist_id = "%user_id%" AND shipping_date != "0000-00-00" AND shipping_date IS NOT NULL',
				'no_data_alert' 		=> [

					'header' 	=> 'No Shipped Orders Yet',
					'body' 		=> 'You do not have any shipped orders yet.'
				]
			],
